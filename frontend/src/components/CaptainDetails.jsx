    ...
    <div>
       <div className='flex items-center justify-between'>
        <div className='flex items-center justify-start gap-3'>
          ...
          <h4 className='text-lg font-medium capitalize'>{ride?.captain?.fullname?.firstname}
            {ride?.captain?.fullname?.lastname}</h4>
        </div>
        <div>
         ...
         <div className='flex p-3 mt-8 bg-gray-50  rounded-xl justify-center gap-5 items-start'>
